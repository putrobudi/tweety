{{-- more like a meta section not footer--}}
<div class="flex">
      ...
      <div
          ...
          <svg viewBox="0 0 20 20" class="mr-1 w-3">
              <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
                  ...
                  <g class="fill-current"> {{-- fill with the current color. --}}
                      <path
          ...
          <button type="submit" class="text-xs">
              {{ $tweet->likes ?: 0 }} {{-- if there's null default to zero or 
        we can update the query to return 0 instead of null. --}}
          </button>
      </div>
  </form>
  <form method="POST" action="/tweets/{{ $tweet->id }}/like">
